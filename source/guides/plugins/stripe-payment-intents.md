...
+===============================================+=================================+===============================================+
| ``centra_checkout_shipping_address_callback`` | ``shippingCountry``             | ``centra_checkout_shipping_address_response`` |
|                                               | ``shippingState``               |                                               |
|                                               | ``shippingZipCode``             |                                               |
+-----------------------------------------------+---------------------------------+-----------------------------------------------+
| ``centra_checkout_shipping_method_callback``  | ``shippingMethod``              | ``centra_checkout_shipping_method_response``  |
+-----------------------------------------------+---------------------------------+-----------------------------------------------+
| ``centra_checkout_payment_callback``          | ``responseEventRequired:false`` | Make a regular ``POST /payment``,             |
|                                               | ``paymentMethod``               | similar to when checkout is submitted,        |
|                                               | ``billingAddress``              | but with the params provided from the event.  |
|                                               | ``shippingAddress``             |                                               |
