...
Our current version of the Checkout API is 4. The only difference between version 3 and 4 is the product catalog endpoints allowing you to filter and access specific catalog data.
...
You can find the Webhook as a separate plugin, and how to set it up is explained under [Plugins / Centra Webhook](/guides/plugins/centra-webhook).
...
[Checkout APIv4 OAS-specification](https://docs.centra.com/swagger-ui/?api=CheckoutAPI)
